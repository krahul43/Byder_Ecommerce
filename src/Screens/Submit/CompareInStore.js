...
const CompareInStore = ({ navigation,route }) => {
    const { imageTicket,distace,orderIdGet,images ,name,current_price} = route.params
  ...
  <Topbarback Textheading={'Compraruyt Online'} navigation={navigation} />
...
{/*       
        <View>
          ...
          <View>
              <TouchableOpacity onPress={() => navigation.navigate('Submit',{distace,imageTicket,orderIdGet,images ,name,current_price})} style={styles.txman}>
