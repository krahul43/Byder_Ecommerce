...
const CompareOnline = ({ navigation,route }) => {
  const { images ,name,current_price} = route.params
    ...
    <>
      ...
      <View style={styles.man}>
        <View style={styles.Topimg}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('Submit',{images ,name,current_price})} disabled={!enableStatus} style={[!enableStatus && styles.disabledButton]}>
